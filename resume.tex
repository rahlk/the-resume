...
ML algorithms for processing millions of legal documents. 
\item Contributions include: 
(1) Clustering more than 1 million documents based word2vec and doc2vec to 
identify representatives for specific legal topics; (2) Developing tools for 
automated text summarization of very large legal documents;
\resumeItemListEnd
